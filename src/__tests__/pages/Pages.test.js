...
describe('Tests for Pages', () => {
  ...
  test('App / Error404', async () => {
    const { getByTestId } = renderWithRouter(<App />, { path: ['other-page'] })

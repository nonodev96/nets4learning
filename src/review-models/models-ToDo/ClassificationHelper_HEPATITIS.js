...
export const MODEL_HEPATITIS = {
  ...
  // @formatter:off
  FORM             : [
    { type: "select", name: "sex",             options: [{ value: "1", text: "Male" }, { value: "2", text: "Female" }] },
    { type: "select", name: "steroid",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "antivirals",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "fatigue",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "malaise",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "anorexia",        options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "liver_big",       options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "liver_firm",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "spleen_palpable", options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "spiders",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "ascites",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "select", name: "varices",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    // ...
  ],
  // @formatter:on
  TABLE_HEADER: [

...
export const MODEL_HEPATITIS = {
  ...
  // @formatter:off
  FORM             : [
    { type: "string", name: "sex",             options: [{ value: "1", text: "Male" }, { value: "2", text: "Female" }] },
    { type: "string", name: "steroid",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "antivirals",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "fatigue",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "malaise",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "anorexia",        options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "liver_big",       options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "liver_firm",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "spleen_palpable", options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "spiders",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "ascites",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "string", name: "varices",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    // ...
  ],
  // @formatter:on
  TABLE_HEADER: [

...
export default function SecondMenu(props) {
  ...
  const modelsDescription = [
    ...
    },
    {
      ...
      text: "Puedes subir tu propia arquitectura para editarla o elegir una nuestra prehecha",
    },
    {
      buttons: [
    ...
    },
    {
      buttons: [
        {
          Title: "Cargar mi modelo ya entrenado",
          accion: handleClickModelCustom,
        },
      ...
      <div className="container">
        ...
        <div
          className={
            buttonActive === -1
              ? "container smargen"
              : "borde container smargen"
          }
        >
          <div className="details-menu">
            {buttonActive !== -1 ? (
              <ButtonDescription
                data={modelsDescription[buttonActive]}
                click={handleClickEmpezar}
              />
            ) : (
              ""
            )}

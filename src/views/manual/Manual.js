          ...
          <Row className={"mt-2"}>
            ...
            <Col xl={12}>
              ...
              <Card className={"mt-3"}>
                ...
                <Card.Body>
                  <ol>
                    <li><b>SGD (Stochastic Gradient Descent – Descenso del gradiente estocástico) (Instituto Tecnológico Autónomo de México, 2017)</b>: el descenso del gradiente es un algoritmo que estima dónde una función genera sus
                      valores más bajos. En el caso de que el modelo de aprendizaje automático sea de gran escala este cálculo puede ser muy costoso. Debido a esto surge el descenso del gradiente estocástico que usa una constante y por
                      consiguiente el número de gradientes a calcular es fijo.
                    </li>
                    <li><b>Momentum</b>: es una variación de la función anterior. “Momentum” es un valor que acelera el descenso del gradiente si el signo del gradiente es el mismo durante diferentes épocas.</li>
                    ...
                    <li><b>Adadelta (Velasco, 2020)</b>: es una variación de AdaGrad en la que se restringe el cálculo de la tasa de entrenamiento de cada peso a una ventana de tamaño fijo de los últimos n gradientes en vez de hacerlo con
                      el gradiente acumulado de cada iteración.
                    </li>
                    <li><b>RMSProp (Velasco, 2020) (Root Mean Square Propagation – Propagación de raíz cuadrática media)</b>: este algoritmo mantiene un factor de entrenamiento diferente para cada dimensión, pero el escalado del factor del
                      entrenamiento se realiza dividiéndolo por la media del declive exponencial del cuadrado de los gradientes.
                    </li>
                    <li><b>Adam (Velasco, 2020) (Adaptive moment estimation – Estimación adaptativa del mo)</b>: es una combinación de AdaGrad y RMSProp. Se mantiene un factor de entrenamiento por parámetro y se calcula RMSProp, además cada
                      factor de entrenamiento se ve afectado por el “momentum” del gradiente.
                    </li>
                  </ol>
                </Card.Body>
              </Card>
              ...
              <Card className={"mt-3"}>
                ...
                <Card.Body>
                  ...
                  <ol>
                    ...
                    <li><b>LogLoss (Shen, 2005) (Pérdida logarítmica)</b>: "LogLoss" o "Logistic Loss" es una función convexa que crece linealmente para números negativos y la hace poco sensible a valores atípicos. Calcula la pérdida
                      logarítmica entre dos tensores.
                    </li>
              ...
              <Card className={"mt-3"}>
                ...
                <Card.Body>
                  <ol>
                    ...
                    <li><b>MeanAbsoluteError (Error absoluto medio)</b>: en estadística, es una medida de la diferencia entre dos variables continuas, aplicada a los modelos de aprendizaje automático estas variables son las etiquetas y las
                      predicciones.
                    </li>

...
} from '../../../neural-networks-utiils/ArchitectureHelper'
import {
  transform_datasetJSON_To_DataFrame
} from "../../../neural-networks-utiils/ClassificationHelper";
import {
  TYPE_ACTIVATION,
  TYPE_OPTIMIZER,
  TYPE_LOSSES,
  TYPE_METRICS
} from "../../../neural-networks-utiils/ArchitectureTypesHelper";
import json_cars from "../../../constants/template_car.json";
import json_iris from "../../../constants/template_iris.json";
import json_lymphatcs from '../../../constants/template_lymphatcs.json'
